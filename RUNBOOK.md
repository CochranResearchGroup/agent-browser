...
[Plan0174](docs/dev/plans/0174-2026-09-12-ci-production-scale-and-process-identity-reliability.md) is OPEN at candidate `5a4fd859`; focused tests, fmt, strict Clippy, and both affected compartments pass. Local comprehensive compilation was blocked by five stale Cargo scopes occupying 905 of 1,024 shared task slots; protected CI is next. No stale-process cleanup, install, or runtime effect is authorized.
