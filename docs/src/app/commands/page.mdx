...
`service events --limit <n>` prints recent reconciliation summaries and browser health transitions without requiring operators to parse the full service state.
