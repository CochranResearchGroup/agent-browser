...
Use `POST /api/service/profiles/<id>/freshness` or MCP `service_profile_freshness_update` to merge bounded-probe readiness evidence into an existing profile without replacing unrelated profile fields.
