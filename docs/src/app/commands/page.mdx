...
The same package exposes <code>@agent-browser/client/service-observability</code> for typed service job, event, incident, incident activity, and trace HTTP reads generated from the matching contract schemas.
