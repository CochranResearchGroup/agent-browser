...
Set <code>service.reconcileIntervalMs</code>, pass <code>--service-reconcile-interval &lt;ms&gt;</code>, or set <code>AGENT_BROWSER_SERVICE_RECONCILE_INTERVAL_MS</code> to run the same persisted browser-health probes automatically in the daemon background.
