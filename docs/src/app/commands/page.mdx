...
The MCP <code>agent-browser://incidents</code> resource and <code>service_incidents</code> tool return the same service incident record schema as HTTP: <code>docs/dev/contracts/service-incident-record.v1.schema.json</code>.
