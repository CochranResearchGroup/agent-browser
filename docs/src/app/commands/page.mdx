...
See <code>examples/service-client/</code> for a copyable software-client workflow that sends a service request and then reads <code>getServiceTrace</code>. Run <code>pnpm test:service-client-example</code> to validate the example in dry-run mode.
