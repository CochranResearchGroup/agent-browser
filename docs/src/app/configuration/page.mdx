...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_SERVICE_RECONCILE_INTERVAL_MS</code></td><td>Run persisted service browser-health reconciliation periodically while the daemon is alive.</td><td>(disabled)</td></tr>
