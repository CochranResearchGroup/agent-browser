...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Worker health, browser health, reconciliation status, managed entity counts, recent service jobs with detail inspection, browser/session/tab detail inspection, filterable service events including tab lifecycle changes, and a reconcile action backed by the service HTTP API</td>
    </tr>
    <tr>
