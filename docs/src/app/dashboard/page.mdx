...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Worker health, browser health, reconciliation status, managed entity counts, recent service events, and a reconcile action backed by the service HTTP API</td>
    </tr>
    <tr>
