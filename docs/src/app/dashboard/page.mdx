...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Worker health, browser health, reconciliation status, managed entity counts, filterable service events, and a reconcile action backed by the service HTTP API</td>
    </tr>
    <tr>
