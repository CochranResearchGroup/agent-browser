...
impl ProfileAccessPreset {
    pub fn permissions(self) -> Vec<ProfilePermission> {
        match self {
...
impl ProfileChildAccess {
    ...
    pub fn narrow_to(&self, requested: &[ProfilePermission]) -> Self {
...
impl ServiceProfileAccessPolicy {
    pub fn shared_local_default(profile_id: &str) -> Self {
        Self {
...
pub fn profile_policy_target_for_preset(
...
pub struct ProfileAccessEvaluation<'a> {
    pub profile_id: &'a str,
    pub explicit_policy: Option<&'a ServiceProfileAccessPolicy>,
    pub subject_id: Option<String>,
    pub assurance: ProfileIdentityAssurance,
    pub connection_instance_id: Option<String>,
...
pub fn effective_profile_permissions(
    policy: &ServiceProfileAccessPolicy,
...
pub struct ProfileChildAccessRequest<'a> {
    pub child: &'a ProfileChildAccess,
    pub current_policy: &'a ServiceProfileAccessPolicy,
    pub subject_id: Option<&'a str>,
    pub assurance: ProfileIdentityAssurance,
    pub connection_instance_id: &'a str,
    pub permission: ProfilePermission,
    pub reconnect: bool,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct ProfileChildAccessEvidence {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ProfileChildAccessResult {
    pub allowed: bool,
    pub reconnected: bool,
    pub reason: &'static str,
    pub denial_evidence: Option<ProfileChildAccessEvidence>,
    pub child: ProfileChildAccess,
}
...
pub fn evaluate_profile_child_access(
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ProfilePolicyMutationRequest<'a> {
    pub expected_revision: u64,
    pub target: ProfilePolicyTarget,
    pub subject_id: Option<&'a str>,
    pub assurance: ProfileIdentityAssurance,
    pub incompatible_occupancy: Vec<String>,
    pub eviction_mode: Option<ProfileEvictionMode>,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ProfilePolicyMutationResult {
    pub outcome: ProfilePolicyMutationOutcome,
    pub policy: ServiceProfileAccessPolicy,
    pub blocking_occupancy: Vec<String>,
    pub eviction_plan: Option<ProfileEvictionPlan>,
    pub eviction_receipt: Option<ProfileEvictionReceipt>,
    pub receipt: ProfilePolicyAuditReceipt,
}
...
pub fn record_profile_eviction_receipt(
