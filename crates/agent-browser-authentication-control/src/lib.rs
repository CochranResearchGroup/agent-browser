...
pub const AUTHENTICATION_RUN_SCHEMA_VERSION: &str = "agent-browser.authentication-run.v3";

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct AuthenticationRunBinding {
    pub service_id: String,
    pub agent_id: String,
    pub task_id: String,
    pub principal_id: String,
    pub target_service_id: String,
    pub target_account_ref: String,
    pub target_organization_ref: String,
    pub challenge_provider_id: String,
    pub challenge_provider_tenant_ref: String,
    pub challenge_provider_account_ref: String,
    pub profile_id: String,
    pub browser_id: String,
    pub session_name: String,
    pub login_tab_id: String,
    pub site_recipe_id: String,
...
pub enum AuthenticationRunState {
    Ready,
    AwaitingIdentifier,
    AwaitingPassword,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum AuthenticationChallengeChannel {
    SmsOtp,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum PasswordPersistencePolicy {
    Save,
    Update,
    Never,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct SiteLoginObservationReceipt {
    ...
    pub page_state_fresh: bool,
    pub site_state: SiteLoginState,
    pub state_instance_id: String,
    pub exact_account_authenticated: bool,
    pub browser_chrome_semantics_used: bool,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct SiteLoginActionReceipt {
    pub provider_id: String,
    pub effect_id: String,
    pub action: AuthenticationActionKind,
    pub state_instance_id: String,
    pub response_only_material_consumption: bool,
    pub secret_material_exposed: bool,
    pub browser_chrome_semantics_used: bool,
    pub persistence_verified: bool,
}

pub trait ResponseOnlySiteLoginAction {
    fn execute(
        &mut self,
...
pub struct SiteLoginActionContext<'a> {
    pub run_id: &'a str,
    pub operation_id: &'a str,
    pub binding: &'a AuthenticationRunBinding,
    pub action: AuthenticationActionKind,
    pub state_instance_id: &'a str,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct ProviderWatchReceipt {
    pub provider_id: String,
    pub watch_id: String,
    pub delivery_fence_id: String,
    pub ready_before_delivery: bool,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct SameProfileNewTabProof {
    pub profile_id: String,
    pub browser_id: String,
    pub session_name: String,
    pub tab_id: String,
    pub opened_in_new_tab: bool,
    pub navigation_consumed_internally: bool,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct AuthenticationActionReceipt {
    pub provider_id: String,
    pub effect_id: String,
    pub action: AuthenticationActionKind,
    pub native_credential_store_used: bool,
    pub credentials_replayed: bool,
    pub challenge_material_consumed: bool,
    pub response_only_material_consumption: bool,
    pub delivery_watch_ready_before_trigger: bool,
    pub delivery_fence_id: Option<String>,
    pub candidate_count: Option<u32>,
    pub same_profile_new_tab: Option<SameProfileNewTabProof>,
}
...
pub trait ResponseOnlyAuthenticationAction {
    fn execute(
        &mut self,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct AuthenticationActionContext<'a> {
    pub run_id: &'a str,
    pub operation_id: &'a str,
    pub binding: &'a AuthenticationRunBinding,
    pub action: AuthenticationActionKind,
    pub challenge_id: Option<&'a str>,
    pub delivery_fence_id: Option<&'a str>,
    pub candidate_count: Option<usize>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum AuthenticationActionFailure {
    ProviderUnavailable,
    DeliveryExpired,
    EffectRejected,
    EffectUnproven,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct AuthenticationVerifierReceipt {
    ...
    pub browser_id: String,
    pub session_name: String,
    pub exact_target_authenticated: bool,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct AuthenticationVerificationContext<'a> {
    pub run_id: &'a str,
    pub operation_id: &'a str,
    pub binding: &'a AuthenticationRunBinding,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum AuthenticationVerifierFailure {
    ProviderUnavailable,
    ObservationFailed,
    TargetAmbiguous,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct AuthenticationTransitionReceipt {
    pub operation_id: String,
    pub from_state: AuthenticationRunState,
    pub to_state: AuthenticationRunState,
    pub action: String,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct AuthenticationRun {
    pub schema_version: String,
    pub run_id: String,
    pub binding: AuthenticationRunBinding,
    pub state: AuthenticationRunState,
    pub max_transitions: u32,
    pub transition_count: u32,
    pub used_operation_ids: BTreeSet<String>,
    pub completed_challenge_ids: BTreeSet<String>,
    #[serde(default)]
    pub completed_site_state_ids: BTreeSet<String>,
    active_challenge: Option<ActiveAuthenticationChallenge>,
    #[serde(default)]
    pub site_observation_receipts: Vec<SiteLoginObservationReceipt>,
    #[serde(default)]
    pub site_action_receipts: Vec<SiteLoginActionReceipt>,
    pub action_receipts: Vec<AuthenticationActionReceipt>,
    pub verifier_receipt: Option<AuthenticationVerifierReceipt>,
    pub transition_receipts: Vec<AuthenticationTransitionReceipt>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum AuthenticationRunError {
...
impl AuthenticationRun {
    ...
    pub fn observe_site_login_state(
        &mut self,
        operation_id: &str,
    ...
    pub fn submit_account_identifier(
        &mut self,
        operation_id: &str,
    ...
    pub fn handle_password_persistence_prompt(
        &mut self,
        operation_id: &str,
    ...
    pub fn submit_native_stored_credentials(
        &mut self,
        operation_id: &str,
    ...
    pub fn active_challenge_binding(
        &self,
    ) -> Option<(
        String,
    ...
    pub fn mark_delivery_triggered(
        &mut self,
        operation_id: &str,
        challenge_id: &str,
    ) -> Result<(), AuthenticationRunError> {
    ...
    pub fn submit_credentials_and_trigger_delivery(
        &mut self,
        operation_id: &str,
        challenge_id: &str,
        action: &mut impl ResponseOnlyAuthenticationAction,
    ...
    pub fn cancel(&mut self, operation_id: &str) -> Result<(), AuthenticationRunError> {
        if matches!(
            self.state,
            AuthenticationRunState::Authenticated
                | AuthenticationRunState::OperatorInterventionRequired
