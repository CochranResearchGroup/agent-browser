...
Use `@agent-browser/client/service-observability` for generated HTTP helpers around service status, collections, config mutations, reconcile, jobs, events, incidents, incident activity, and traces. It exposes `getServiceStatus`, `getServiceProfiles`, `getServiceBrowsers`, `getServiceSessions`, `getServiceTabs`, `getServiceSitePolicies`, `getServiceProviders`, `getServiceChallenges`, `postServiceReconcile`, `upsertServiceProfile`, `deleteServiceProfile`, `upsertServiceSession`, `deleteServiceSession`, `upsertServiceSitePolicy`, `deleteServiceSitePolicy`, `upsertServiceProvider`, `deleteServiceProvider`, `getServiceJobs`, `getServiceJob`, `getServiceEvents`, `getServiceIncidents`, `getServiceIncident`, `getServiceIncidentActivity`, and `getServiceTrace`.
