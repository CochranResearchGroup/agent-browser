...
For `service.browserCapabilityRegistry`, treat configured registry content as the advisory service-state view. Do not infer that registry records are merged by ID or used by routing yet.
