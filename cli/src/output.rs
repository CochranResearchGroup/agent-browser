...
Notes:
  ...
  - Reconcile plan seals rejoin_owned_browser when the current lease already authorizes rejoin. Apply reuses exact custody checks, rejects foreign or ambiguous work, and uses the plan expiry for the rejoined work lease. Profile-owner lease warnings do not determine ordinary tab permission.
