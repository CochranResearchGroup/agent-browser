...
Notes:
  ...
  - The stream server exposes the service surface at /api/service/status, /api/service/profiles, /api/service/profiles/<id>, /api/service/sessions, /api/service/sessions/<id>, /api/service/browsers, /api/service/tabs, /api/service/site-policies, /api/service/site-policies/<id>, /api/service/providers, /api/service/providers/<id>, /api/service/challenges, /api/service/trace, /api/service/jobs, /api/service/jobs/<id>, /api/service/jobs/<id>/cancel, /api/service/incidents, /api/service/incidents/<id>, /api/service/incidents/<id>/activity, /api/service/incidents/<id>/acknowledge, /api/service/incidents/<id>/resolve, /api/service/events, and /api/service/reconcile.
...
Notes:
  ...
  - Typed browser_* tools also accept targetServiceId, targetService, targetServiceIds, and targetServices for first-command profile selection.
  ...
  - Launch commands without explicit profile or runtimeProfile can include serviceName plus targetServiceId, targetService, targetServiceIds, or targetServices so persisted service profiles are selected by authenticated target match, then target match, then caller service match.
