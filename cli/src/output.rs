...
Notes:
  ...
  - browser_navigate, browser_requests, browser_request_detail, browser_headers, browser_offline, browser_cookies_*, browser_storage_*, browser_user_agent, browser_viewport, and browser_geolocation provide typed schemas for common navigation, request-inspection, session-shaping, cookie, and storage workflows.
  - browser_command queues HTTP-parity actions such as navigate, viewport, user_agent, geolocation, headers, offline, cookies_get, storage_get, requests, and request_detail with params copied into the queued daemon command.
