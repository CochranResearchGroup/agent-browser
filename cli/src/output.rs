...
debugging, a browser-health transition timeline, a grouped incident browser
panel with acknowledgement and resolution actions, and incident filters for
handling state plus crash, disconnect, recovery, timeout, and cancellation
signals.
...
Notes:
  ...
  - The stream server exposes the service surface at /api/service/status, /api/service/profiles, /api/service/sessions, /api/service/browsers, /api/service/tabs, /api/service/site-policies, /api/service/providers, /api/service/challenges, /api/service/trace, /api/service/jobs, /api/service/jobs/<id>, /api/service/jobs/<id>/cancel, /api/service/incidents, /api/service/incidents/<id>, /api/service/incidents/<id>/activity, /api/service/incidents/<id>/acknowledge, /api/service/incidents/<id>/resolve, /api/service/events, and /api/service/reconcile.
...
Notes:
  ...
  - MCP tools include service_job_cancel, service_trace, browser_navigate, browser_requests, browser_request_detail, browser_headers, browser_offline, browser_cookies_get, browser_cookies_set, browser_cookies_clear, browser_storage_get, browser_storage_set, browser_storage_clear, browser_user_agent, browser_viewport, browser_geolocation, browser_permissions, browser_timezone, browser_locale, browser_media, browser_dialog, browser_upload, browser_download, browser_wait_for_download, browser_har_start, browser_har_stop, browser_route, browser_unroute, browser_console, browser_errors, browser_pdf, browser_response_body, browser_clipboard, browser_command, browser_snapshot, browser_get_url, browser_get_title, browser_tabs, browser_screenshot, browser_click, browser_fill, browser_wait, browser_type, browser_press, browser_hover, browser_select, browser_get_text, browser_get_value, browser_get_attribute, browser_get_html, browser_get_styles, browser_count, browser_get_box, browser_is_visible, browser_is_enabled, browser_check, browser_is_checked, browser_uncheck, browser_scroll, browser_scroll_into_view, browser_focus, and browser_clear.
  - browser_navigate, browser_requests, browser_request_detail, browser_headers, browser_offline, browser_cookies_*, browser_storage_*, browser_user_agent, browser_viewport, browser_geolocation, browser_permissions, browser_timezone, browser_locale, browser_media, browser_dialog, browser_upload, browser_download, browser_wait_for_download, browser_har_*, browser_route, browser_unroute, browser_console, browser_errors, browser_pdf, browser_response_body, and browser_clipboard provide typed schemas for common navigation, request-inspection, session-shaping, observability, artifact, file-transfer, HAR, routing, cookie, and storage workflows.
  - browser_command queues HTTP-parity actions such as navigate, viewport, user_agent, geolocation, permissions, timezone, locale, emulatemedia, dialog, upload, download, waitfordownload, har_start, har_stop, route, unroute, console, errors, pdf, responsebody, clipboard, headers, offline, cookies_get, storage_get, requests, and request_detail with params copied into the queued daemon command.
