...
Notes:
  ...
  - MCP tools include service_job_cancel, service_trace, browser_navigate, browser_requests, browser_request_detail, browser_headers, browser_offline, browser_command, browser_snapshot, browser_get_url, browser_get_title, browser_tabs, browser_screenshot, browser_click, browser_fill, browser_wait, browser_type, browser_press, browser_hover, browser_select, browser_get_text, browser_get_value, browser_get_attribute, browser_get_html, browser_get_styles, browser_count, browser_get_box, browser_is_visible, browser_is_enabled, browser_check, browser_is_checked, browser_uncheck, browser_scroll, browser_scroll_into_view, browser_focus, and browser_clear.
  - browser_navigate, browser_requests, browser_request_detail, browser_headers, and browser_offline provide typed schemas for common navigation, request-inspection, and session-shaping workflows.
  - browser_command queues HTTP-parity actions such as navigate, headers, offline, requests, and request_detail with params copied into the queued daemon command.
