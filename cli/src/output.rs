...
Notes:
  ...
  - Browser Session Manager handoff creation and resolution use only the current SQLite Ready route-keeper binding. Missing or stale keeper, XRDP, display, or public-operator-origin evidence fails before browser launch or focus. Raw Guacamole and provider URLs are never returned as operator handoffs.
