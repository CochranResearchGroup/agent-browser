...
Notes:
  ...
  - Crash recovery traces expose browser_health_changed, browser_recovery_started, and browser_health_changed events in order, including structured reason, processExitCause for process exits, retry-budget details, and recovery policy source metadata.
