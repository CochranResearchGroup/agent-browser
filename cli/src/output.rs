...
Notes:
  ...
  - MCP tools include service_job_cancel, service_trace, browser_navigate, browser_requests, browser_request_detail, browser_headers, browser_offline, browser_cookies_get, browser_cookies_set, browser_cookies_clear, browser_storage_get, browser_storage_set, browser_storage_clear, browser_command, browser_snapshot, browser_get_url, browser_get_title, browser_tabs, browser_screenshot, browser_click, browser_fill, browser_wait, browser_type, browser_press, browser_hover, browser_select, browser_get_text, browser_get_value, browser_get_attribute, browser_get_html, browser_get_styles, browser_count, browser_get_box, browser_is_visible, browser_is_enabled, browser_check, browser_is_checked, browser_uncheck, browser_scroll, browser_scroll_into_view, browser_focus, and browser_clear.
  - browser_navigate, browser_requests, browser_request_detail, browser_headers, browser_offline, browser_cookies_*, and browser_storage_* provide typed schemas for common navigation, request-inspection, session-shaping, cookie, and storage workflows.
  - browser_command queues HTTP-parity actions such as navigate, headers, offline, cookies_get, storage_get, requests, and request_detail with params copied into the queued daemon command.
