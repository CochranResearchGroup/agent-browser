...
Notes:
  ...
  - Operator-requested close health events include shutdownReasonKind plus polite-close and force-kill outcome metadata so clients can distinguish expected shutdown from unexpected process exit.
