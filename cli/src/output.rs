...
Notes:
  ...
  - Configured route-keeper startup proves every retained host exited before opening provider connections; interrupted adoption also requires the interrupted adopter to have exited. Live or ambiguous ownership and unsupported retained states stop startup. Pending recovery is not remote-view readiness.
