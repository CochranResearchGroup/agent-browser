    ...
    json!({
        ...
        "contracts": {
            ...
            "serviceProfileRecovery": {
                ...
                "mitigationActions": super::service_profile_acquisition::mitigation_action_registry(),
                "dominantBlockerOrder": super::service_profile_acquisition::profile_blocker_dominance_order(),
                "noLaunch": false,
            },
