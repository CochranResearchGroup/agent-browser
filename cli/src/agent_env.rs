...
const KNOWN_VARS: &[&str] = &[
    ...
    "AGENT_BROWSER_PRESENTATION_HARD_MAXIMUM",
    "AGENT_BROWSER_PRESENTATION_HUMAN_RESERVE",
    "AGENT_BROWSER_PRESENTATION_MAX_QUEUE_DEPTH",
    "AGENT_BROWSER_PRESENTATION_PROVIDER_INVENTORY_PATH",
    "AGENT_BROWSER_PRESENTATION_RECOVERY_RESERVE",
    "AGENT_BROWSER_PRESENTATION_WARM_MINIMUM",
...
AGENT_BROWSER_PRODUCTION_PRESENTATION_INVENTORY_PATH=/tmp/production-inventory.json
AGENT_BROWSER_PRESENTATION_WARM_MINIMUM=2
...
"#;
        ...
        assert_eq!(
            parsed.get("AGENT_BROWSER_PRODUCTION_PRESENTATION_INVENTORY_PATH"),
            Some(&"/tmp/production-inventory.json".to_string())
        );
        assert_eq!(
            parsed.get("AGENT_BROWSER_PRESENTATION_WARM_MINIMUM"),
            Some(&"2".to_string())
        );
