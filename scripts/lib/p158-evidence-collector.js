...
export const P158_AGGREGATE_ENTRY_PATHS = Object.freeze([
  ...
  'docs/dev/contracts/p158-logging-evidence-corpus.v1.schema.json',
  ...
  'scripts/lib/p158-logging-evidence-harvester.js',
  'scripts/lib/p158-live-campaign-assembly.js',
  ...
  'scripts/run-p158-w6-malformed-line-live.js',
  ...
  'scripts/prepare-p158-live-campaign.js',
  ...
  'scripts/test-p158-logging-evidence-harvester.js',
  'scripts/test-p158-live-campaign-assembly.js',
  ...
  'scripts/test-p158-w6-malformed-line-live.js',
