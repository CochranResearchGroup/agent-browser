...
`details.profileSelectionReason`. MCP typed browser tools accept the same target
...
fallback, or explicit override. Pass `profile` or `runtimeProfile` only for override
