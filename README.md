...
- **Service view** — worker and browser health cards, reconciliation status, managed entity counts, filterable service events with detail inspection, and a reconcile action
