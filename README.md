...
`service remedies apply --escalation browser_degraded` and
`--escalation os_degraded_possible` return retry responses and update persisted
browser state without launching Chrome.
