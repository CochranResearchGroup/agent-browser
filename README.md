...
when agent-browser has no suitable one. Run `pnpm test:service-client-example-live`
to validate the main trace example against a real isolated daemon and browser
session.
