...
`summarizeServiceTraceAttention`, `acquireServiceLoginProfile`, `runServiceAccessPlanMonitorRunDue`, `runServiceAccessPlanBrowserCapabilityPreflight`, `postServiceReconcile`, upsert and delete helpers for profiles, sessions, site policies, providers, and browser capability registry records,
