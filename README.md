...
the same profile. MCP typed browser tools accept the same target profile hints,
...
browser, or overlapped another exclusive profile lease. Pass `profile` or `runtimeProfile` only for override
